...
SYSTEM_PROMPT = (
    ...
    " 5. Формат ответа: всегда отвечай строго в формате json, только одним из двух возможных вариантов: approve или deny. При deny можешь не объяснять причины, я тебе доверяю. При approve ты должен собрать полный объект согласно примеру. Не используй кавычки в тексте. Или экранируй их. \n"
    "———\n"
    "```json\n"
    "// при approve\n"
    "{\n"
